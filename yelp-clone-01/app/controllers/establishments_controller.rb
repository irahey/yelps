class EstablishmentsController < ApplicationController
  ...
  def new
    ...
    #@establishment = Establishment.all.by_name
  end
  ...
  private
    ...
    def establishment_params
      params.require(:establishment).permit(:name, :street_address, :city, :province, :postal_code, :phone, :website, :avatar_url, :description)
    end
end
